package com.common.compactcalender;
...
import static com.common.compactcalender.CompactCalendarView.FILL_LARGE_INDICATOR;
import static com.common.compactcalender.CompactCalendarView.NO_FILL_LARGE_INDICATOR;
import static com.common.compactcalender.CompactCalendarView.SMALL_INDICATOR;
    ...
    private void loadAttributes(AttributeSet attrs, Context context) {
        if (attrs != null && context != null) {
            ...
            try {
                ...
                eventTextColor = typedArray.getColor(R.styleable.CompactCalendarView_compactCalendarEventDayTextColor, eventTextColor);
...
//                            canvas.drawText(String.valueOf(7), xPosition, yPosition, dayPaint);
            ...
            if (dayRow == 0) {
                ...
                if (day <= 0) {
                    ...
                    String strDate = (monthToDrawCalender.get(Calendar.YEAR)
                            + "-" + (String.format("%02d", monthToDrawCalender.get(Calendar.MONTH) +1))
