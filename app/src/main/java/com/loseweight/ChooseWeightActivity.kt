...
class ChooseWeightActivity : BaseActivity() {
    val TAG = ChooseWeightActivity::class.java.name + Constant.ARROW

    var binding: ActivityChooseWeightBinding? = null
    ...
    private fun init() {
        ...
        binding!!.npWeightUnit.setOnValueChangedListener(object :
            ...
            override fun onValueChange(picker: NumberPicker?, oldVal: Int, newVal: Int) {
                ...
                if (picker!!.value == 1) {
                    ...
                    binding!!.npWeight.value =
                        Utils.kgToLb(binding!!.npWeight.value.toDouble()).roundToInt()
                    ...
                    binding!!.npWeight.value =
                        Utils.lbToKg(binding!!.npWeight.value.toDouble()).roundToInt()
        ...
        binding!!.btnNext.setOnClickListener {
            ...
            val i = Intent(this, ChooseTargetWeightActivity::class.java)
            startActivity(i)
        }
