...
class BodyFocusAdapter(internal var context: Context) : RecyclerView.Adapter<BodyFocusAdapter.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val rowSideMenuBinding = DataBindingUtil.inflate<ItemBodyFocusBinding>(
            inflater,
            R.layout.item_body_focus, parent, false
        )
    ...
    inner class MyViewHolder(internal var rowSideMenuBinding: ItemBodyFocusBinding) :
